...
[![Sonarcloud Status](https://sonarcloud.io/api/project_badges/measure?project=JoeAlisson_async-mmocore&metric=alert_status&metric=alert_status)](https://sonarcloud.io/dashboard?id=JoeAlisson_async-mmocore)
